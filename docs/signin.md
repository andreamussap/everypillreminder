...
Facebook and Google are different accounts, and the App treats them as such.
...
So, for example, you sign in with Google and add a medication. Then you sign out, and sign in again, but this time with Facebook. In this case, you won't be able to access the medication and friends that you previously added while using Google
 

### Facebook App is not installed on the smartphone

If you have a Facebook account but Facebook App is not installed on the smartphone, when you try to sign in to **EveryPill Reminder** with Facebook you'll see the default Facebook screen to log in to the application. 

![](/images/fb_login_screen.png)

In this case, input your Facebook information and proceed to the login.
